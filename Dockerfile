...
COPY .github/workflows/ci.yml .github/workflows/cd-production-check.yml .github/workflows/cd-production-promotion.yml .github/workflows/cd-shadow-worker-activation.yml .github/workflows/cd-shadow-worker-rollout.yml ./.github/workflows/
