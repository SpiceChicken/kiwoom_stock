...
_SETTING_SPEC_ROWS: Tuple[Tuple[Any, ...], ...] = (
    ...
    ("KIWOOM_REQUIRE_SHADOW_TELEMETRY", "strict boolean", "shadow execution", None,
     "shadow telemetry attestation", False,
     "exactly 1 when the admitted telemetry sidecar is required", ("prod", "production-like")),
    ("KIWOOM_SHADOW_TELEMETRY_PATH", "file path", "shadow execution", None,
     "shadow telemetry sidecar", False,
     "absolute path inside the admitted shadow volume", ("prod", "production-like")),
